...
# from tests.gripper_control.dh_driver_all_old import DHBinaryDriver
...
class DHController(mp.Process):
    def __init__(self,
        ...
        super().__init__(name="DHController")
    ...
    def run(self):
        ...
        try:
            with DHBinaryDriver(
                ...
                print('gripper curr_pos: ',curr_pos)
                # curr_pos = 100.0
            ...
            self.ready_event.set()
            if self.verbose:
                print(f"[DHController] Disconnected from robot: {self.hostname}")